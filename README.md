...
<p align="center">
  ...
  <h3 align="center">Hour Rangers Arcade</h3>

  <p align="center">
    React Asteroids based game with hour rangers theme. Used to test react features for game development and the Canvas Api toolset. 
    <br />
    <a href="https://github.com/ladellerby/hour-rangers-arcade"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://ladellerby.com">View Demo</a>
    ·
    <a href="https://github.com/ladellerby/hour-rangers-arcade/issues">Report Bug</a>
    ·
    <a href="https://github.com/ladellerby/hour-rangers-arcade/issues">Request Feature</a>
  </p>
</p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/ladellerby/hour-rangers-arcade.git
   ```
...
See the [open issues](https://github.com/ladellerby/hour-rangers-arcade/issues) for a list of proposed features (and known issues).
...
Project Link: [https://github.com/ladellerby/hour-rangers-arcade](https://github.com/ladellerby/hour-rangers-arcade)
